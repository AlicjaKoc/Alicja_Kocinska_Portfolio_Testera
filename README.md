...
- [Skills](#skills)
- [Tools](#tools)
- [:one::zero::zero: days of testing adventure](#100-days-of-testing-adventure) :heart: :muscle:
...
Are you curious about what I'm doing to become a better and better tester? My Mentor inspired me to share a sample month of my testing adventure. Each day I learned, repeated or practiced testing-related topics, including professional English :wink: 
When the 30th day arrived, I found it very motivating to learn (even if only for 20 minutes) something useful for the testing profession every day. Also satisfying, so I decided to turn ":three::zero: days of testing adventure" into ":one::zero::zero: days of testing adventure" :blush:.
...
|Day 25|April 15, 2023| Repetition of Jira - Udemy course: Jira from the basics - project management (part 1) | |
...
|Day 29|April 19, 2023| Repetition of Jira - Udemy course: Jira from the basics - project management (part 2) | |
|Day 30|April 20, 2023| Meeting with the Mentor (online) | | 
|Day 31|April 21, 2023| Online conference Testing Stage 2023: Janet Gregory "Thinking Holistically about Quality and Testing" | [link](https://www.youtube.com/watch?v=AM12IIbebWo&list=PL2DFnm8LBPXqIxbExAyMkSwHezdsTATe5)|
|Day 32|April 22, 2023| Testing Stage 2023: Sowmya Sridharamurthy "API test automation without code" | [link](https://www.youtube.com/watch?v=F-KFfufwjiU&list=PL2DFnm8LBPXqIxbExAyMkSwHezdsTATe5&index=3) |
|Day 33|April 23, 2023| Testing Stage 2023: Lisa Crispin "A Holistic Approach to Testing in Continuous Delivery" | [link](https://www.youtube.com/watch?v=cYAUkVxjCaQ&list=PL2DFnm8LBPXqIxbExAyMkSwHezdsTATe5&index=5)|
|Day 34|April 24, 2023| Testing Stage 2023: Mykola Panasiuk "Level up your approaches to Test Coverage" | [link](https://www.youtube.com/watch?v=sPnsbE-B0yM&list=PL2DFnm8LBPXrdVYir7xLqgAcDPvopi7Lk&index=4) |
|Day 35|April 25, 2023| 3QA meeting | https://trojqa.pl/qa-accelerators-59-meetup|
|Day 36|April 26, 2023| Testing Stage 2023: Nikolay Advolodkin "ChatGPT Goes Tech: A Web Development Tale" | [link](https://www.youtube.com/watch?v=Yoh6Yk6Trjk&list=PL2DFnm8LBPXrdVYir7xLqgAcDPvopi7Lk&index=6) |
|Day 37|April 27, 2023| Live testing workshop with Natalia Pawlowska, author of the book "Journey through the world of testing" | |
|Day 38|April 28, 2023| First steps with SoapUI - installation and introduction | [link 1](https://www.soapui.org/getting-started/introduction/), [link 2](https://www.soapui.org/getting-started/soapui-interface) |
|Day 39|April 29, 2023| SQL Project | |
|Day 40|April 30, 2023| SoapUI - first tests | [link](https://www.soapui.org/getting-started/soap-test/) |
